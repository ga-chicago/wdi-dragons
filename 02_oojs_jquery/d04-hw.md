...
2. Check out `02_oojs_jquery/your_name/fellowship`. This is where you will work. Starter data has been provided. There is an `index.html` and a few other files to work with.
